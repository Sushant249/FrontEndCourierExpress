  ...
  return (
    <div>
      ...
      <div className="vh-100 d-flex">
        <form className="col-md-6 text-white">
          <div className="container">
            ...
            <div className="col-10 mt-10" style={{ marginTop: 10 }}>
              {" "}
              <button
                type="submit"
                className="btn btn-primary btn-md ms-5 active"
...
export default DboyUpdateProfile;
